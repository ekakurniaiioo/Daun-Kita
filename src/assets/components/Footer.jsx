...
export function Footer() {
  return (
    <section>
      <footer className="footer flex justify-between items-center bg-forest text-neutral-content py-10 px-24">
        <aside>
          <Sprout />
          <p className="text-2xl text-cream font-poppins">
            Daun<span className="text-amber-500">Kita</span>
          </p>
          <p className="font-inter">Jam balas chat (09.00 sampai 20.00)</p>
        </aside>
        <nav>
          <h6 className="text-xl text-cream font-poppins">Social</h6>
